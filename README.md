...
5. **Timing & chat sounds** — video style presets (Regular / Sped up), how fast "you" type, how slow "they" reply, and the iMessage sounds: send/receive blips, typing-indicator rumble and keyboard clicks. Receipts flip Delivered → Read right before they reply, like the real thing.
